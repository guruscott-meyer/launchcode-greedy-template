...
public class MetrolinkCalculatorTest {
    ...
    public void noonInWellstonReturnsZero() {
        ...
        try {
            ResultSet resultSet = statement.executeQuery( "SELECT arrival_time FROM stops NATURAL JOIN stop_times WHERE stop.stop_name = \"WELLSTON METROLINK STATION\" GROUP BY stop_name ORDER BY stop_name;");
